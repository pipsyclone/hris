        ...
        <input
            ...
            {{ $attributes
                ...
                ->class([
                    ...
                    'border-red-500' => $errors->has($errorTarget),
                ])
            }}
        />
...
@if ($elementType === 'checkbox-toggle')
    <div class="flex items-center justify-between">
        <div x-data="{ checkboxToggle: false }">
            <label for="checkboxLabelOne"
                ...
                <div class="relative">
                    <input type="checkbox" id="checkboxLabelOne" {{ $attributes }} class="sr-only" @change="checkboxToggle = !checkboxToggle" />
